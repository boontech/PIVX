...
In order to support loading of multiple wallets in boondevcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is boondevcoin.cpp.
...
Changes to boondevcoin.cpp
----------------------
boondevcoin.cpp is the entry point into boondevcoin-qt, and as such, will require some minor modifications to provide hooks for
