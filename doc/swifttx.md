...
This mechanism has been integrated into Bitcore-Node-boondevcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/boondevcoin-Project/insight-api-boondevcoin#web-socket-api](https://github.com/boondevcoin-Project/insight-api-boondevcoin#web-socket-api) 
* API: [https://github.com/boondevcoin-Project/insight-api-boondevcoin#swifttx-transactions](https://github.com/boondevcoin-Project/insight-api-boondevcoin#swifttx-transactions) 
...
By default, the boondevcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the boondevcoin Core daemon:
