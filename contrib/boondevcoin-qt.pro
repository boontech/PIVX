...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/boondevcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/boondevcoin-cli.cpp \
           src/boondevcoin-tx.cpp \
           src/boondevcoin.cpp \
           src/db.cpp \
           ...
           src/qt/boondevcoin.cpp \
           src/qt/boondevcoinstrings.cpp \
...
RESOURCES += src/qt/boondevcoin.qrc src/qt/boondevcoin_locale.qrc

TRANSLATIONS += src/qt/locale/boondevcoin_bg.ts \
                src/qt/locale/boondevcoin_de.ts \
                src/qt/locale/boondevcoin_en.ts \
                src/qt/locale/boondevcoin_es.ts \
                src/qt/locale/boondevcoin_fi.ts \
                src/qt/locale/boondevcoin_fr.ts \
                src/qt/locale/boondevcoin_it.ts \
                src/qt/locale/boondevcoin_ja.ts \
                src/qt/locale/boondevcoin_pl.ts \
                src/qt/locale/boondevcoin_pt.ts \
                src/qt/locale/boondevcoin_ru.ts \
                src/qt/locale/boondevcoin_sk.ts \
                src/qt/locale/boondevcoin_sv.ts \
                src/qt/locale/boondevcoin_vi.ts \
                src/qt/locale/boondevcoin_zh_CN.ts \
                src/qt/locale/boondevcoin_zh_TW.ts
