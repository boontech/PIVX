Contributing to boondevcoin Core
============================

The boondevcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the boondevcoin Core project, and is not to be
confused with overall boondevcoin Network Protocol consensus changes.

Whether a pull request is merged into boondevcoin Core rests with the project merge
...
Patches that change boondevcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the boondevcoin consensus, it must have been
...
The project leader is the release manager for each boondevcoin Core release.
