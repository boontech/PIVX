...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("boondevcoin Core"),
     ...
     * override -datadir in the boondevcoin.conf file in the default data directory
     * (to be consistent with boondevcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
