...
/** Utility functions used by the boondevcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render boondevcoin addresses in monospace font
...
// Parse "boondevcoin:" URI into recipient object, return true on successful parsing
