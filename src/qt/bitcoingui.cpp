                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("boondevcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a boondevcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and boondevcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About boondevcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about boondevcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for boondevcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your boondevcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified boondevcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a boondevcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the boondevcoin Core help message to get a list with possible boondevcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("boondevcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to boondevcoin network", "", count));
}
...
{
    QString strTitle = tr("boondevcoin Core"); // default title
