...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("boondevcoin Core boondevcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  boondevcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded boondevcoin transaction") + "\n" +
                               "  boondevcoin-tx [options] -create [commands]   " + _("Create hex-encoded boondevcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded boondevcoin transaction
