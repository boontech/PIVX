...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop boondevcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "boondevcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* boondevcoin features */
        {"boondevcoin", "masternode", &masternode, true, true, false},
        {"boondevcoin", "masternodelist", &masternodelist, true, true, false},
        {"boondevcoin", "mnbudget", &mnbudget, true, true, false},
        {"boondevcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"boondevcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"boondevcoin", "mnsync", &mnsync, true, true, false},
        {"boondevcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"boondevcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use boondevcoind, or the -server option to boondevcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> boondevcoin-cli " + methodname + " " + args + "\n";
}
